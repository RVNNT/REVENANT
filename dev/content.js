  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    items: [
        ...
        entries: [
          {
            ...
            links: [
              { t: "📖 МікроГЕС — повний покроковий гайд", u: "#section/r0/microhes" }
            ]
          },
          {
      ...
      // ── МікроГЕС (внутрішній розділ R0, не показується на головній) ───
      {
        ...
        entries: [
          ...
          },
          {
            ...
            steps: [
              { t: "Підготуй диск і лопаті", c: "Пробий отвір у центрі CD ТОЧНО по діаметру валу.\nПідготуй 8–12 однакових ложок." },
              { t: "Приклей лопаті та тест", c: "Рівномірно по краю диска, опуклою стороною НАЗОВНІ, кут ~45°.\nТЕСТ: облий водою — крутиться від легкого потоку? ✅" }
            ]
          },
          {
            ...
            steps: [
              { t: "Визнач полюси (ОБОВ'ЯЗКОВО)", c: "З компасом: піднеси магніт — бік що притягується = N → познач маркером.\nБез компасу: підвісь голку на нитці — вкаже північ." },
              { t: "Розмісти магніти N-S-N-S по колу", c: "Приклей, тримай 30 сек, одразу скотч поверх.\n⚠️ Сушка мін. 2 год (звичайний клей) або 30 хв (епоксидка)." }
            ]
          },
          {
            ...
            steps: [
              { t: "Намотай 4–8 котушок", c: "Шаблон ~4×6 см, 200–400 витків, залиш 15 см кінців.\nТонший дріт (0.3–0.5 мм) = вища напруга." },
              { t: "Зачисти кінці і з'єднай послідовно", c: "Шкіркою або полум'ям до мідного блиску.\nКінець 1-ї → Початок 2-ї → ... Залиш 2 вільних кінці — вихід.\n⚠️ Зазор ротор-статор = 1–3 мм (оптимум 1.5–2 мм)." }
            ]
          },
          {
      ...
      // ── R2 — POLIS ────────────────────────────────────────────
      {
        ...
        title: "R2 — Поліс",
        title_en: "R2 — Polis",
        subtitle: "до 500,000 осіб · Multi-TB storage · T2 BGP fiber · повна е-держава",
        subtitle_en: "up to 500,000 people · Multi-TB storage · T2 BGP fiber · full e-government",
        ...
        entries: [
          {
            name: "T2 Network — Fiber між Hex-вузлами", name_en: "T2 Network — Fiber between Hex nodes",
            priority: "КРИТИЧНО",
            why: "T2: fiber між Hex-вузлами, BGP, EVPN/MPLS, ≥10 Mbps/абонент. Об'єднує декілька T1 мереж.",
            why_en: "T2: fiber between Hex nodes, BGP, EVPN/MPLS, ≥10 Mbps/subscriber. Unifies multiple T1 networks.",
          ...
          },
          {
            ...
            priority: "БАЖАНО",
            why: "Full Nix/Guix модель відтворюваності — R2 roadmap. Full PKI + Hardware root of trust. Offline cold backup repos.",
            why_en: "Full Nix/Guix reproducibility model — R2 roadmap. Full PKI + Hardware root of trust. Offline cold backup repos.",
      ...
      // ── R3 — MEGALOPOLIS ──────────────────────────────────────
      {
        ...
        color: "#a855f7",
        title: "R3 — Мегаполіс",
        title_en: "R3 — Megalopolis",
        subtitle: "до 1.2M осіб · Multi-DC · T3 metro optical rings · державний масштаб",
        subtitle_en: "up to 1.2M people · Multi-DC · T3 metro optical rings · state scale",
        ...
        entries: [
          {
            name: "T3 Network — Metro optical rings + 5G/6G", name_en: "T3 Network — Metro optical rings + 5G/6G",
            priority: "КРИТИЧНО",
            why: "T3: metro optical rings, 5G/6G, об'єднує декілька T2 мереж. Deep redundancy, active-active DC, distributed Kafka backbone.",
            why_en: "T3: metro optical rings, 5G/6G, unifies multiple T2 networks. Deep redundancy, active-active DC, distributed Kafka.",
          ...
          },
          {
            ...
            priority: "ВАЖЛИВО",
            why: "Наукові кластери для R&D, strategic-scale PKI (root of trust для всіх нижніх рівнів). R3 автономний без зовнішньої мережі.",
            why_en: "Scientific clusters for R&D, strategic-scale PKI (root of trust for all lower levels). R3 autonomous without external networks.",
    ...
    items: [
      {
        ...
        emoji: "[ROAD]",
        color: "#a855f7",
        title: "ROADMAP v0.1.x → v1.0",
        title_en: "ROADMAP v0.1.x → v1.0",
        subtitle: "Поточний стан: R0 (Clan). Наступне: R1 (Hex, 25k людей).",
        subtitle_en: "Current state: R0 (Clan). Next: R1 (Hex, 25k people).",
        analogy: "Як semver: кожен Rn — major версія цивілізаційної інфраструктури. Ми на v0 (pre-release).",
        analogy_en: "Like semver: each Rn is a major version of civilization infrastructure. We're at v0 (pre-release).",
        entries: [
          {
            name: "v0.1.x — R0 Clan (поточний)", name_en: "v0.1.x — R0 Clan (current)",
            priority: "КРИТИЧНО",
            why: "R0: Bootstrap від Android/ноутбука до повноцінного dev середовища для 50-200 людей. 64-128 GB USB. Dev stack, Offline LLM, T0 mesh (LoRa + Reticulum), FreeCAD, Economy ledger.",
            why_en: "R0: Bootstrap from Android/laptop to full dev environment for 50-200 people. 64-128 GB USB. Dev stack, Offline LLM, T0 mesh (LoRa + Reticulum), FreeCAD, Economy ledger.",
            targets: ["64GB USB", "Termux + gcc", "Briar/Jami mesh", "Offline LLM ~4B Q4", "FreeCAD CAD/CAM"],
            links: [{ t: "REVENANT v0.1.3 spec", u: "https://github.com/revenant-protocol/revenant" }]
          },
          {
            name: "v0.2.x — R1 Hex (в розробці)", name_en: "v0.2.x — R1 Hex (in development)",
            priority: "ВАЖЛИВО",
          ...
          {
            name: "v1.0 — R2 Поліс / R3 Мегаполіс", name_en: "v1.0 — R2 Polis / R3 Megalopolis",
            priority: "БАЖАНО",
            why: "R2: до 500,000 людей, multi-DC, повна e-government. R3: до 1.2M, metro optical rings, 5G/6G.",
            why_en: "R2: up to 500,000 people, multi-DC, full e-government. R3: up to 1.2M, metro optical rings, 5G/6G.",
