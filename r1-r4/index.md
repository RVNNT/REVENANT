...
R1  → Hex           (up to 25,000)
R2a → Polis         (up to 500,000)
R2b → Megalopolis   (up to 1.2M)
R3  → Covenant      (2+ Poleis)
```
...
T2a → Polis          (fiber between Hex nodes, BGP)
...
> Full Nix/Guix model (~40–80 GB) — roadmap for R2a.
...
**Network: T3**
- Inter-Polis backbone
- Unifies multiple T2a/T2b networks
...
| R2a — Polis | T2a | Multi-TB storage | scales |
| R2b — Megalopolis | T2b | Multi-DC | state scale |
| R3 — Covenant | T3 | Distributed | multi-site |
